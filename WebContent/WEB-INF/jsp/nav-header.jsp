...
<body>
	...
	<div class="collapse navbar-collapse">
		<ul class="nav navbar-nav">
			<li class="li-border"><a class="mystyle-color" href="index">管理控制台</a></li>
			<li class="dropdown li-border">
				<a href="#" class="dropdown-toggle mystyle-color" data-toggle="dropdown">产品与服务
				...
				<div class="dropdown-menu topbar-nav-list">
					<div class="topbar-nav-col">
						<div class="topbar-nav-item">
							...
							<ul>
								<li><a href="#"> <span class="glyphicon glyphicon-road"></span>
										<span class="">云服务器 ECS</span>
								</a></li>
								<li><a href="#"> <span
										class="glyphicon glyphicon-picture"></span> <span class="">云服务器
											ECS</span>
								</a></li>
								<li><a href="#"> <span class="glyphicon glyphicon-gift"></span>
										<span class="">云服务器 ECS</span>
								</a></li>
							</ul>
						</div>
		...
		<ul class="nav navbar-nav pull-right">
			...
			<li class="dropdown li-border">
				<a href="#" class="dropdown-toggle mystyle-color" data-toggle="dropdown">${name}<span class="caret"></span></a>
		        <!----下拉框选项---->
		         <div class="dropdown-menu dropdown-menu-right topbar-nav-list">
		             <div class="topbar-nav-col">
		               <div class="topbar-nav-item">		      
			               <ul>
			                 <li><a href="userInfo">
